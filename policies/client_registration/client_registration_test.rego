...
# PG_CHANGED: limit dynamic client_registration
test_allowed_client_uris_whitelist if {
	# No whitelist configured - should allow any valid client_uri
	client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
		"client_uri": "https://example.com/",
		"redirect_uris": ["https://example.com/callback"],
	...
	# Whitelist configured and client_uri matches exactly
	client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
		"client_uri": "https://web.devserver3.local",
		"redirect_uris": ["https://web.devserver3.local/callback"],
	}
		with client_registration.allowed_client_uris as ["https://web.devserver3.local"]

	# Whitelist configured and client_uri NOT in list - should fail
	not client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
...
test_allowed_client_uris_trailing_slash if {
	# Config has no trailing slash, client sends with trailing slash - should match
	client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
		"client_uri": "https://web.devserver3.local/",
		"redirect_uris": ["https://web.devserver3.local/callback"],
	...
	# Config has trailing slash, client sends without trailing slash - should match
	client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
		"client_uri": "https://web.devserver3.local",
		"redirect_uris": ["https://web.devserver3.local/callback"],
	...
	# Both have trailing slash - should match
	client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
		"client_uri": "https://web.devserver3.local/",
		"redirect_uris": ["https://web.devserver3.local/callback"],
...
test_allowed_client_uris_multiple if {
	# Multiple URIs in whitelist - first one matches
	client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
		"client_uri": "https://app1.example.com",
		"redirect_uris": ["https://app1.example.com/callback"],
	}
		with client_registration.allowed_client_uris as [
			"https://app1.example.com",
			"https://app2.example.com",
			"https://app3.example.com",
		]

	# Multiple URIs in whitelist - middle one matches
	client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
		"client_uri": "https://app2.example.com",
	...
	# Multiple URIs in whitelist - none match
	not client_registration.allow with input.client_metadata as {
		"grant_types": ["authorization_code"],
		"client_uri": "https://evil.com",
		"redirect_uris": ["https://evil.com/callback"],
...
test_normalize_uri if {
	# Test the normalize_uri helper function
	client_registration.normalize_uri("https://example.com/") == "https://example.com"
	client_registration.normalize_uri("https://example.com") == "https://example.com"
	client_registration.normalize_uri("https://example.com/path/") == "https://example.com/path"
	client_registration.normalize_uri("https://example.com/path") == "https://example.com/path"
}
