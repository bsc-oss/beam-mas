# Changes in PG matrix-authentication-service 1.17.0+pg1 (28-05-2026)

Upstream merge ✨:

- Base update to v1.17.0 (https://github.com/element-hq/matrix-authentication-service/tree/v1.17.0)

# Changes in PG matrix-authentication-service 1.14.0+pg1 (07-04-2026)

Upstream merge ✨:

- Base update to v1.14.0 (https://github.com/element-hq/matrix-authentication-service/tree/v1.14.0)

# Changes in PG matrix-authentication-service 1.11.0+pg3(03-2026)

Bugfix 🐛:

- Prevent double-click on consent page from causing "Authorization grant already used" error
