...
use mas_router::{CompatLoginSsoAction, UrlBuilder, PostAuthAction};
...
use crate::pg_user_info::{fetch_user_email};
...
pub async fn get(
    ...
    // PG_CHANGED: post-logout action
    let post_auth_action = Some(PostAuthAction::continue_compat_sso_login(id));
