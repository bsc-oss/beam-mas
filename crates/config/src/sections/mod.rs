...
pub use self::{
    ...
    passwords::{
     ...
     // PG_CHANGED
    pg::{PgConfig, PgSessionExpirationConfig},
    policy::PolicyConfig,
...
pub struct RootConfig {
    ...
    /// PG_CHANGED: PG-specific configuration options
    #[serde(default, skip_serializing_if = "PgConfig::is_default")]
    pub pg: PgConfig,
}
