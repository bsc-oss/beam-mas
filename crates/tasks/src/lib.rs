...
pub async fn init(
    ...
    worker
        ...
        // PG_CHANGED
        .register_handler::<mas_storage::queue::ExpirePgSessionsJob>()
        .register_handler::<mas_storage::queue::ExpirePgOAuthSessionsJob>()
        ...
        .add_schedule(
            ...
            "45 */15 * * * *".parse()?,
            mas_storage::queue::ExpirePgSessionsJob,
        )
        .add_schedule(
