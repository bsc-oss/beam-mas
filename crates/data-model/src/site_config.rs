...
/// PG_CHANGED PG session expiration configuration
///
...
///   `short_lived_max_lifetime`
/// - Sessions with `urn:pg:session:long-lived` scope expire after
///   `long_lived_max_lifetime`
/// - Sessions must have been inactive for at least `inactivity_ttl`
#[derive(Debug, Clone)]
...
pub struct SiteConfig {
    ...
    /// PG_CHANGED: PG session expiration configuration
    pub pg_session_expiration: Option<PgSessionExpirationConfig>,
}
