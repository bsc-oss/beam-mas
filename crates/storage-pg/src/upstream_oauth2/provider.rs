...
impl TryFrom<ProviderLookup> for UpstreamOAuthProvider {
    ...
    fn try_from(value: ProviderLookup) -> Result<Self, Self::Error> {
        ...
        Ok(UpstreamOAuthProvider {
            ...
            // PG_CHANGED
            pg_app_scheme: value.pg_app_scheme,
...
// PG_CHANGED: added "pg_app_scheme".
#[async_trait]
impl UpstreamOAuthProviderRepository for PgUpstreamOAuthProviderRepository<'_> {
    ...
    async fn add(
        ...
        Ok(UpstreamOAuthProvider {
            ...
            // PG_CHANGED
            pg_app_scheme: params.pg_app_scheme,
        })
    }
            ...
            r#"
                ...
                ON CONFLICT (upstream_oauth_provider_id)
                    ...
                    SET
                        ...
                        pg_app_scheme = EXCLUDED.pg_app_scheme,
    ...
    async fn list(
        ...
        let (sql, arguments) = Query::select()
            ...
            .expr_as(
                Expr::col((
                    UpstreamOAuthProviders::Table,
                    UpstreamOAuthProviders::PgAppScheme,
                )),
                ProviderLookupIden::PgAppScheme,
            )
            .expr_as(
                Expr::col((
                    UpstreamOAuthProviders::Table,
