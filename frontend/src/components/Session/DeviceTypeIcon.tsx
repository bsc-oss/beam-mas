...
import IconMobile from "@pg/compound-design-tokens/assets/web/icons/mobile";
import IconUnknown from "@pg/compound-design-tokens/assets/web/icons/unknown";
import IconBrowser from "@pg/compound-design-tokens/assets/web/icons/web-browser";
